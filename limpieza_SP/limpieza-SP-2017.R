...
dirData <- "D:/seminario/SP/SP_2017.TXT"
outputDir <- "D:/seminario/SP/limpia/SP_2017.csv"
...
names(data)
mantener_columnas <- c(3,4,7,9,11,13,44,47,49,62,63,64,71,82,86,90,94,98,102)
