...
outputDir <- "D:/seminario/SB11/limpia/SB11_2014.csv"

## importar data
periodo1 <- read_delim("D:/seminario/SB11/SB11_20141.TXT", 
                       delim = "¬", escape_double = FALSE, 
                       trim_ws = TRUE)
periodo2 <- read_delim("D:/seminario/SB11/SB11_20142.TXT", 
                       delim = "¬", escape_double = FALSE, 
                       trim_ws = TRUE)
...
names(data_periodo2)
mantener_columnas_p2 <- c(3,4,6,8,16,18,23,24,27,32,33,118,120,122,124,130)
data_limpiap2 <- data_periodo2[mantener_columnas_p2]
names(data_limpiap2)

## cambiar nombre a las variables para que coincidan con el otro periodo
names(data_limpiap1)
names(data_limpiap1)[12] = "punt_sociales_ciudadanas"
names(data_limpiap1)[13] = "punt_ingles"
names(data_limpiap1)[14] = "punt_lectura_critica"
names(data_limpiap1)[15] = "punt_matematicas"
names(data_limpiap1)[16] = "punt_c_naturales"
